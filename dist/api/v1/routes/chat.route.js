...
const controllerChat = __importStar(require("../controllers/chat.controller"));
const validateChat = __importStar(require("../../../validates/chat.validate"));
router.post("/send", validateChat.sendMessage, controllerChat.sendMessage);
router.post("/send-file", validateChat.sendFileMessage, upload.single("file_url"), uploadCloud.upload, controllerChat.sendFileMessage);
